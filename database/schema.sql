...
--
-- Host: 127.0.0.1    Database: bangundaya
-- ------------------------------------------------------
...
--
-- Current Database: `bangundaya`
--

/*!40000 DROP DATABASE IF EXISTS `bangundaya`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `bangundaya` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
CREATE TABLE `category` (
  ...
  `type` enum('product','portofolio','service','material','testimoni') NOT NULL,
...
CREATE TABLE `testimoni` (
  ...
  `testimoni_name` varchar(30) NOT NULL,
  `message` text NOT NULL,
...
-- Dump completed on 2026-05-30 14:20:48
