                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">List testimoni</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="w-100 d-flex justify-content-between align-items-center">
                                            <h5>Testimoni</h5>
                                            <a href="<?= base_url(); ?>testimoniadmin/add" class="btn btn-primary">Add Testimoni</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="dt-responsive table-responsive">
                                            <table id="table_testimoni" class="table table-striped table-bordered nowrap" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
														<th>Name</th>
...
<script>
    ...
    function list_testimoni(keyword, length) {
        $('#table_testimoni').DataTable().destroy();
        $('#table_testimoni').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('testimoniadmin/list'); ?>",
                "type": "POST",
                "data": {
                    "keyword": keyword,
                    "length": length,
    ...
    function buttonDelete(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                document.location.href = "<?= base_url(); ?>testimoniadmin/delete_testimoni/" + id;
            }
        })
    }
</script>